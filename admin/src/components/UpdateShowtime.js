...
import { getAllRooms, getAllMovie, updateShowtimeById } from '../services/API';

const UpdateShowtime = ({showtime,onUpdate}) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await updateShowtimeById(showtime.id ,showtimeData);
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group controlId="movie_id">
                            ...
                            <Form.Control as="select" name="movie_id" value={showtimeData.movie_id} onChange={handleChange} required>
